...
$feedback=\DB::table('feedback')->orderBy('id' ,'DESC')->get(); 
                 /*feedback table connection to the database*/
...
<html lang="en-US">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="{{asset('dashboard')}}/assets/css/jquery.dataTables.css"/>
		<!--My CSS-->
					...
					<div class="col-1">
						<div class="users_view_left">
							<ul>
								...
								<li id="menu_insert">insert special menu</li>
								<li id="menu_show">show special menu</li>
							</ul>
						</div>
					</div>
					<div class="col-11">
							...
							<table class="table table-dark table-striped" id="dataTable">
							 ...
							 <?php 
								...
								<tr>
									...
									<td >
										<a type="button" class="btn btn-sm btn-success delBtn" data-toggle="modal" data-target="#delModel">
											<i class="fa fa-trash"></i>
										</a>
									<!--<a href="{{url('/feedback/delete/'.$data->id)}}">Delete</a>-->
									<div class="modal fade" id="delModel"  role="dialog" aria-labelledby="exampleModalLongTitle1" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												<div class="modal-header">
													...
													<form action="{{url('/feedback/delete/'.$data->id)}}" id="delForm" method="get" enctype="multipart/form-data">
														{{csrf_field()}}
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a href="{{url('/feedback/delete/ '.$data->id)}}" class="btn btn-danger">Yes</a>
        </div>    
      </div>
    </div>
  </div>
				                           ...
				                           <div class="row">
				                            ...
				                            <div class="row">
				 							...
				 							<div class="row">
				                              <div class="col-md-6">
				                                 <p>
				                                    <input type="text" placeholder="Total" name="item_5" value="" >
				                                 </p>
				                              </div>
				                              <div class="col-md-6">
				                                 <p>
		...
		<footer class="footer_area">
			<div class="container">
				<div class="footer text-center">
					...
					<p>&copy copyright - the Paradise - developed by <a href="#">Shinur</a></p>
				</div>
			</div>
		</footer>
